...
/*********************************************************
*NAME:          screenManMoveAtGunsight
*PURPOSE:
*  Send the LGM to the current gunsight tile position.
*  buildS selects the action (use BsTrees for base capture).
*********************************************************/
...
/* Push current tank shells/mines/armour/trees to the frontend status bars. */
